...
| `log_click` | `(self, widget_name: str, widget_type: str='', extra: dict \| None=None)` | Args: |
...
| `log_analysis_step` | `(self, step: str, parameters: dict \| None=None, results: dict \| None=N` | Args: |
