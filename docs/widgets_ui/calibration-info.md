...
| `format_isotope_label` | `(self, element_key)` |  |
| `get_mass_number_for_sorting` | `(self, formatted_label)` |  |
| `find_matching_threshold_key` | `(self, formatted_isotope, element_thresholds)` |  |
| `find_matching_limit_key` | `(self, formatted_isotope, element_limits)` |  |
...
| `create_bottom_buttons` | `(self, layout)` |  |
| `populate_data` | `(self)` |  |
...
| `create_item` | `(self, value, editable=True)` |  |
| `create_scientific_item` | `(self, value)` |  |
| `create_decimal_item` | `(self, value, decimals=2)` |  |
| `create_quality_item` | `(self, r_squared)` |  |
| `create_status_item` | `(self, r_squared, method_data, limit_data)` |  |
