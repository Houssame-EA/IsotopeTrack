...
| Method | Signature | Description |
|--------|-----------|-------------|
| `__init__` | `(self, logo_path: Optional[str]=None, app_name: str='IsotopeTrack', ve` | Args: |
...
| Method | Signature | Description |
|--------|-----------|-------------|
| `__init__` | `(self, logo_path: Optional[str]=None, main_window_class: Optional[type` | Args: |
