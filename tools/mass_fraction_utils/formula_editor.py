...
class FormulaComboBox(QLineEdit):
    compound_selected = Signal(Compound)

    def __init__(self,
                 compound_model: CompoundDatabaseModel,
                 default_formula: str = "",
        ...
        self.compound_model.setParent(self)
    ...
    def _formula_selected(self, index: QModelIndex):
        ...
        self.compound_selected.emit(compound)

# Old Formula Combobox
